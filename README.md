...
- The lower precisions have less mantissa and always round ties to zero, but are otherwise IEEE compliant. A compiler option can enable RTE for MUL only (recommended) or all operations, harming performance by ~10-30%.
