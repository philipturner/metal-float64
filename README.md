...
- `float43_t` - GPU-friendly format with 15 bits exponent and 32 bits mantissa, with 17 bits wasted. Must be converted to/from FP64 on the CPU. Throughput ratio is ~1:30-34 compared to FP32.
