...
- The lower precisions have less mantissa and always round ties to zero, but are otherwise IEEE compliant. If you are experiencing significant drift toward zero, a compiler option can enable RTE for MUL and the multiply step in FMA. Another compiler option can enable RTE everywhere, at a ~25% performance cost.
